...
import { HtmlBundleService } from '@/core/HtmlBundleService.js';
import { HTML_BUNDLE_MIME_TYPE } from '@/const.js';
...
export class DriveService {
	...
	constructor(
		...
		private htmlBundleService: HtmlBundleService,
	) {
	...
	public async addFile({
		...
		// Handle HTML Bundle (ZIP file containing HTML)
		let htmlBundlePath: string | null = null;
		if (info.type.mime === HTML_BUNDLE_MIME_TYPE) {
			try {
				// Extract HTML Bundle to files/html-bundles/{fileId}/
				const bundleExtractPath = this.internalStorageService.resolvePath(`html-bundles/${file.id}`);
			...
			file.isHtmlBundle = false;
			file.htmlBundlePath = null;
		}
