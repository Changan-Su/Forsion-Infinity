...
export class MiDriveFile {
	...
	@Column('boolean', {
		default: false,
		comment: 'Whether the DriveFile is an HTML Bundle (ZIP containing HTML content).',
	})
	public isHtmlBundle: boolean;

	@Column('varchar', {
		length: 1024, nullable: true,
		comment: 'The path where the HTML Bundle is extracted.',
	})
	public htmlBundlePath: string | null;
}
