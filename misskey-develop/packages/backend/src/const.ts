...
// Forbidden file extensions in HTML Bundle (security)
export const HTML_BUNDLE_FORBIDDEN_EXTENSIONS = [
	'.exe', '.bat', '.cmd', '.com', '.scr', '.vbs', '.js', '.jar',
	'.sh', '.bash', '.ps1', '.app', '.dmg', '.deb', '.rpm',
	'.msi', '.pkg', '.dll', '.so', '.dylib',
];
